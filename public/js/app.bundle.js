...
var constantRoutes = [{
  ...
  component: __webpack_require__.e(/*! import() */ 2).then(__webpack_require__.bind(null, /*! ./views/Home.vue */ "./resources/js/views/Home.vue")),
  name: 'home'
}, {
  path: '/employes',
  component: Promise.all(/*! import() */[__webpack_require__.e(3), __webpack_require__.e(0)]).then(__webpack_require__.bind(null, /*! ./views/Employes.vue */ "./resources/js/views/Employes.vue")),
  name: 'employes'
}, {
  path: '/404',
  component: __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.bind(null, /*! ./views/404.vue */ "./resources/js/views/404.vue")),
  name: '404'
}, {
  path: '*',
  redirect: '/404'
